...
Ainsi, l’IA reçoit le contenu de la page d’API déjà validé manuellement, ce qui réduit les risques d’erreur concernant le chemin, le mode d’authentification et le schéma des paramètres.
