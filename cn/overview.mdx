...
<CardGroup cols={2}>
  ...
  <Card title="多种视频协议" icon="film">
    同时公开 `/v1/videos`、Seedance 原生格式、Omni 与 Veo 格式说明，以及部分模型专用视频接口。
  </Card>
  <Card title="图像能力" icon="image">
    提供 OpenAI 图片生成与编辑接口，并保留 Gemini 图片生成等模型专用格式。
  </Card>
  <Card title="音乐生成" icon="music">
    提供音乐生成任务接口，支持提示词描述、轻音乐/纯伴奏、歌词高级模式，并通过任务 ID 查询结果。
  </Card>
  <Card title="长任务查询" icon="clock">
    视频、音乐与部分生成任务统一使用任务 ID、response id 或 operation name 查询，适合异步集成与回查。
  </Card>
</CardGroup>
